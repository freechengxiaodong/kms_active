/*!
 * @name 無名
 * @description 不惊扰别人的宁静，就是慈悲；不伤害别人的自尊，就是善良 无云控，纯本地，无验证
 * @version v0.0.1
...
(() => {
    ...
    const E = {
        ...
        tx: {
            info: {name: "企鹅音乐", type: "music", actions: ["musicUrl"], qualitys: ["128k"]},
            musicUrl({songmid: e, strMediaMid: r}, t) {
                t = E[t];
                const s = `{"req_0":{"module":"vkey.GetVkeyServer","method":"CgiGetVkey","param":{"filename":["${"" + t.s + r + t.e}"],"guid":"0","songmid":["${e}"],"songtype":[0],"uin":"","loginflag":1,"platform":"20"}},"comm":{"qq":"","authst":"","ct":"26","cv":"2010101","v":"2010101"}}`;
                return console.log(s), new Promise((t, o) => {
                    n("https://u.y.qq.com/cgi-bin/musicu.fcg?data=" + encodeURIComponent(s), {
                        method: "GET",
                        headers: {"User-Agent": "com.dragon.read/5.5.132 ttnet/1.46.7 okhttp/4.10.0"}
                    }, (e, r) => {
                        return console.log(JSON.stringify(r.body, "", "  ")), e ? o(e) : (r = (e = r.body).req_0.data.midurlinfo[0]["purl"], "" === r ? o(new Error("failed")) : (e = e.req_0.data.sip[0] + r, void t(e)))
                    })
                })
            }
        },
        wy: {
            info: {name: "网易音乐", type: "music", actions: ["musicUrl"], qualitys: ["128k", "320k", "flac", "flac24bit"]},
            musicUrl({songmid: e}, r) {
                r = f[r];
                e = {ids: JSON.stringify([e]), level: r, encodeType: "flac"};
                const s = D("/api/song/enhance/player/url/v1", e);
                return new Promise((t, o) => {
                    n("https://interface.music.163.com/eapi/song/enhance/player/url/v1", {
                        method: "POST",
                        form: s,
                        headers: {cookie: "EVNSM=1.0.0; versioncode=9000025; buildver=240205104600; ntes_kaola_ad=1; mobilename=sukiseki; osver=13; MUSIC_U=; os=android; channel=bubugao1; appver=9.0.25; packageType=release"}
                    }, (e, r) => {
                        return e ? o(e) : ({
                            url: e,
                            freeTrialInfo: r
        ...
        mg: {
            info: {name: "咪咕音乐", type: "music", actions: ["musicUrl"], qualitys: ["128k", "320k", "flac", "flac24bit"]},
            musicUrl(e, r) {
                r = y[r], console.log(e);
                ...
                return new Promise((o, s) => {
                    console.log(r), n(t, {
                        ...
                        if (console.log(r.body), e) return s(e);
                        let t = r.body.data?.url;
                        if (!t) return s(new Error("failed"));
    ...
    r(e.request, ({source: e, action: r, info: t}) => {
        if ("musicUrl" === r) return B[e].musicUrl(t.musicInfo, t.type).catch(e => (console.log(e.message), Promise.reject(e)))
    });
    var C, b, g = {};
    for ([C, b] of Object.entries(B)) g[C] = b.info;
    t(e.inited, {status: !0, openDevTools: !1, sources: g})
})();
